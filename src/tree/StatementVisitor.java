...
public interface StatementVisitor {
    ...
    void visitSkipNode(StatementNode.SkipNode skipNode);

    void visitDoNode(StatementNode.DoNode doNode);

    void visitDoBranchNode(StatementNode.DoBranchNode doBranchNode);
}
